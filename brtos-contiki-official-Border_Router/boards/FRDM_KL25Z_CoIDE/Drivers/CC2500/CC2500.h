...
#define TI_CC_CSn_LOW		GPIOPinReset(GPIOC_BASE, GPIO_PIN_4)
#define TI_CC_CSn_HIGH		GPIOPinSet(GPIOC_BASE, GPIO_PIN_4)
#define TI_CC_GDO0_PIN_READ	GPIOPinRead(GPIOC_BASE, GPIO_PIN_8)
#define TI_CC_GDO0_PIN		GPIO_PIN_8
